...
class getSearchEnginesControllerService extends AdminKernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.LBlqvH6'] ?? $container->load('get_ServiceLocator_LBlqvH6Service'))->withContext('PrestaShopBundle\\Controller\\Admin\\Configure\\ShopParameters\\SearchEnginesController', $container));
