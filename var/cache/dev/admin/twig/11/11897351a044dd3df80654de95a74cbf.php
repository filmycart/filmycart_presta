...
class __TwigTemplate_e38745fefa1f185696f3f405db0e70e9 extends Template
{
  ...
  <div class=\"row\">
    ";
        ...
        ";
            // line 45
            yield Twig\Extension\CoreExtension::include($this->env, $context, "@PrestaShop/Admin/Module/Includes/dropdown_categories.html.twig", ["topMenuData" => (isset($context["topMenuData"]) || array_key_exists("topMenuData", $context) ? $context["topMenuData"] : (function () { throw new RuntimeError('Variable "topMenuData" does not exist.', 45, $this->source); })())]);
            yield "
      </div>
    ";
        }
    ...
    ";
        // line 56
        if ((((isset($context["level"]) || array_key_exists("level", $context) ? $context["level"] : (function () { throw new RuntimeError('Variable "level" does not exist.', 56, $this->source); })()) > Twig\Extension\CoreExtension::constant("PrestaShop\\PrestaShop\\Core\\Security\\Permission::LEVEL_UPDATE")) && array_key_exists("bulkActions", $context))) {
            // line 57
...
(isset($context["js_translatable"]) || array_key_exists("js_translatable", $context) ? $context["js_translatable"] : (function () { throw new RuntimeError('Variable "js_translatable" does not exist.', 69, $this->source); })()));
    ...
    {
        return array (  126 => 69,  125 => 67,  118 => 62,  112 => 59,  108 => 58,  105 => 57,  103 => 56,  100 => 55,  94 => 52,  90 => 51,  87 => 50,  85 => 49,  82 => 48,  76 => 45,  72 => 44,  69 => 43,  67 => 42,  48 => 25,);
    }
  ...
  <div class=\"row\">
    {% if topMenuData is defined %}
      <div class=\"col-md-4 module-top-menu-item\">
        ...
        {{ include('@PrestaShop/Admin/Module/Includes/dropdown_categories.html.twig', {topMenuData: topMenuData}) }}
      </div>
    {% endif %}
...
", "@PrestaShop/Admin/Module/Includes/menu_top.html.twig", "/var/www/html/filmycart_presta/src/PrestaShopBundle/Resources/views/Admin/Module/Includes/menu_top.html.twig");
    }
}
