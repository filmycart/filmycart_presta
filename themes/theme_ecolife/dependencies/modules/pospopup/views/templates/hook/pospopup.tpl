<div id="posnewsletterpopup" class="newsletterpopup">
	<div class="posnewsletter-content">
		<div class="pnp-close">
		...
		<div class="pnp-content">
			...
			<div class="pnp-newsletter-form">
				<form
					data-action="{url entity=index params=['fc' => 'module', 'module' => 'ps_emailsubscription', 'controller' => 'subscription']}"
