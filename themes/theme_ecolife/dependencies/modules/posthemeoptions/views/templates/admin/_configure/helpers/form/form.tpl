								...
								<div class="form-group">
									<div class="row">
										<select class="pos-layouts fixed-width-xxl">
											...
											<option value="autopart5">Autopart 5</option>
											<option value="autopart6">Autopart 6</option>
											<option value="autopart7">Autopart 7</option>
											<option value="autopart8">Autopart 8</option>
											...
											<option value="cosmetic7">Cosmetic 7</option>
											<option value="cosmetic8">Cosmetic 8</option>
											<option value="cosmetic9">Cosmetic 9</option>
											...
											<option value="decoration5">Decoration 5</option>
											<option value="decoration6">Decoration 6</option>
											<option value="decoration7">Decoration 7</option>
											...
											<option value="digital5">Digital 5</option>
											<option value="digital6">Digital 6</option>
											<option value="digital7">Digital 7</option>
											<option value="digital8">Digital 8</option>
											<option value="digital9">Digital 9</option>
											...
											<option value="fashion9">Fashion 9</option>
											<option value="fashion10">Fashion 10</option> 
											<option value="fashion11">Fashion 11</option>
											<option value="fashion12">Fashion 12</option>
											...
											<option value="furniture5">Furniture 5</option>
											<option value="furniture6">Furniture 6</option> 
											<option value="furniture7">Furniture 7</option>
											<option value="furniture8">Furniture 8</option> 
											<option value="furniture9">Furniture 9</option> 
											...
											<option value="jewelry5">Jewelry 5</option>
											<option value="jewelry6">Jewelry 6</option>
											<option value="jewelry7">Jewelry 7</option>
											<option value="jewelry8">Jewelry 8</option>
											...
											<option value="shoes5">Shoes 5</option>		 										
											...
											<option value="underwear1">Underwear 1</option>
											<option value="underwear2">Underwear 2</option>
											<option value="underwear3">Underwear 3</option>
											<option value="underwear4">Underwear 4</option>
