...
class AdminPosThemeoptionsController extends ModuleAdminController {
    ...
    function ajaxImportData($layout){
		...
		if($layout == 'cosmetic5' || $layout == 'cosmetic6' || $layout == 'cosmetic7'){
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '1');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
		...
		if($layout == 'digital5'|| $layout == 'digital6' || $layout == 'digital7'){
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '0');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
			...
			$results .= $this->updateValue($themeoption . 'sidebar', 'normal');
			$results .= $this->updateValue($themeoption . 'p_display', 1);
			$results .= $this->updateValue($themeoption . 'sticky_background', '#0363CDCC');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_name', '"Rubik", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Rubik", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_main_color', '#0363CD');
			$results .= $this->updateValue($themeoption . 'p_name_colorh', '#0363CD');
			$results .= $this->updateValue($vegamenu . '_behaviour', 3);
			$results .= $this->updateValue('POSSEARCH_CATE', 0);  
            $images = array();
    	}
		if($layout == 'digital8'){
			...
			$results .= $this->updateValue($themeoption . 'sidebar', 'normal');
			$results .= $this->updateValue($themeoption . 'p_display', 1);
			$results .= $this->updateValue($themeoption . 'sticky_background', '#2E427DCC');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_name', '"Rubik", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Rubik", sans-serif');
		...
		if($layout == 'furniture5' || $layout == 'furniture6' || $layout == 'furniture7' || $layout == 'furniture8'){
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '1');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
			$results .= $this->updateValue($themeoption . 'g_body_bg_color', '');
			$results .= $this->updateValue($themeoption . 'layout', 'wide');
			$results .= $this->updateValue($themeoption . 'g_title_font_weight', '4');
			$results .= $this->updateValue($themeoption . 'g_dark', '0');
			$results .= $this->updateValue($themeoption . 'container_width', '1200px');
			$results .= $this->updateValue($themeoption . 'boxed_width', '');
			$results .= $this->updateValue($themeoption . 'sidebar', 'normal');
			$results .= $this->updateValue($themeoption . 'p_display', 4);
			$results .= $this->updateValue($themeoption . 'sticky_background', '#ffffffcc');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@100;200;300;400;500;600;700;800;900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_name', '"Roboto Slab", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@100;200;300;400;500;600;700;800;900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Roboto Slab", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_main_color', '#9C6D3A');
			$results .= $this->updateValue($themeoption . 'p_name_colorh', '#9C6D3A');
			$results .= $this->updateValue($vegamenu . '_behaviour', 2);
			$results .= $this->updateValue('POSSEARCH_CATE', 0);  
            $images = array();
    	}
		if($layout == 'food1'){
			...
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Open Sans", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_main_color', '#D54343');
			$results .= $this->updateValue($themeoption . 'p_name_colorh', '#D54343');
			$results .= $this->updateValue($vegamenu . '_behaviour', 2);
			$results .= $this->updateValue('POSSEARCH_CATE', 0);  
            $images = array();
    	}
		if($layout == 'food2'){
			...
			$results .= $this->updateValue($themeoption . 'sidebar', 'normal');
			$results .= $this->updateValue($themeoption . 'p_display', 1);
			$results .= $this->updateValue($themeoption . 'sticky_background', '#D54343cc');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&display=swap');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_name', '"Open Sans", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Open Sans", sans-serif');
		...
		if($layout == 'food3'){
			...
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Open Sans", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_main_color', '#54ac00');
			$results .= $this->updateValue($themeoption . 'p_name_colorh', '#54ac00');
			$results .= $this->updateValue($vegamenu . '_behaviour', 1);
			$results .= $this->updateValue('POSSEARCH_CATE', 0);  
            $images = array();
    	}
		...
		if($layout == 'digital9'){
			...
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Open Sans", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_main_color', '#E81212');
			$results .= $this->updateValue($themeoption . 'p_name_colorh', '#E81212');
			$results .= $this->updateValue($vegamenu . '_behaviour', 2);
			$results .= $this->updateValue('POSSEARCH_CATE', 0);  
            $images = array();
    	}
		if($layout == 'furniture9'){
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '1');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
			...
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Open Sans", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_main_color', '#F17B08');
			$results .= $this->updateValue($themeoption . 'p_name_colorh', '#F17B08');
			$results .= $this->updateValue($vegamenu . '_behaviour', 2);
			$results .= $this->updateValue('POSSEARCH_CATE', 0);  
            $images = array();
    	}
		if($layout == 'cosmetic9'){
			...
			$results .= $this->updateValue($themeoption . 'sidebar', 'normal');
			$results .= $this->updateValue($themeoption . 'p_display', 1);
			$results .= $this->updateValue($themeoption . 'sticky_background', '#fffffCC');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&display=swap');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_name', '"Open Sans", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Open Sans", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_main_color', '#b09e64');
			$results .= $this->updateValue($themeoption . 'p_name_colorh', '#b09e64');
			$results .= $this->updateValue($vegamenu . '_behaviour', 2);
			$results .= $this->updateValue('POSSEARCH_CATE', 0);  
            $images = array();
    	}
		if($layout == 'shoes5'){
			...
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Open Sans", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_main_color', '#fa6d18');
			$results .= $this->updateValue($themeoption . 'p_name_colorh', '#fa6d18');
			$results .= $this->updateValue($vegamenu . '_behaviour', 2);
			$results .= $this->updateValue('POSSEARCH_CATE', 0);  
            $images = array();
    	}
		if($layout == 'jewelry5' || $layout == 'jewelry7'){
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '1');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
			...
			$results .= $this->updateValue($themeoption . 'g_title_font_weight', '4');
			$results .= $this->updateValue($themeoption . 'g_dark', '0');
			$results .= $this->updateValue($themeoption . 'container_width', '1130px');
			$results .= $this->updateValue($themeoption . 'boxed_width', '');
			$results .= $this->updateValue($themeoption . 'sidebar', 'normal');
			$results .= $this->updateValue($themeoption . 'p_display', 1);
			$results .= $this->updateValue($themeoption . 'sticky_background', '#FFFFFFCC');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_name', '"Lato", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Lato", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_main_color', '#C29958');
			$results .= $this->updateValue($themeoption . 'p_name_colorh', '#C29958');
			$results .= $this->updateValue($vegamenu . '_behaviour', 2);
			$results .= $this->updateValue('POSSEARCH_CATE', 0);  
            $images = array();
    	}
		if($layout == 'jewelry6'){
			...
			$results .= $this->updateValue($themeoption . 'sidebar', 'normal');
			$results .= $this->updateValue($themeoption . 'p_display', 1);
			$results .= $this->updateValue($themeoption . 'sticky_background', '#F4F4F4CC');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_name', '"Lato", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Lato", sans-serif');
		...
		if($layout == 'underwear1'){
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '1');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
			$results .= $this->updateValue($themeoption . 'g_body_bg_color', '#EBEBEB');
			$results .= $this->updateValue($themeoption . 'layout', 'boxed');
			$results .= $this->updateValue($themeoption . 'g_title_font_weight', '3');
			$results .= $this->updateValue($themeoption . 'g_dark', '0');
			$results .= $this->updateValue($themeoption . 'container_width', '1200px');
			...
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Rubik", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_main_color', '#EE3875');
			$results .= $this->updateValue($themeoption . 'p_name_colorh', '#EE3875');
			$results .= $this->updateValue($vegamenu . '_behaviour', 2);
			$results .= $this->updateValue('POSSEARCH_CATE', 0);  
            $images = array();
    	}
		if($layout == 'underwear2'){
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '1');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
		...
		if($layout == 'underwear3' || $layout == 'underwear4'){
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '1');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
		...
		if($layout == 'autopart5'){
			...
			$results .= $this->updateValue($themeoption . 'sidebar', 'normal');
			$results .= $this->updateValue($themeoption . 'p_display', 1);
			$results .= $this->updateValue($themeoption . 'sticky_background', '#23232BCC');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_name', '"Rubik", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Rubik", sans-serif');
		...
		if($layout == 'autopart6' || $layout == 'autopart8'){
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '1');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
		...
		if($layout == 'autopart7'){
			...
			$results .= $this->updateValue($themeoption . 'sidebar', 'normal');
			$results .= $this->updateValue($themeoption . 'p_display', 1);
			$results .= $this->updateValue($themeoption . 'sticky_background', '#003980CC');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_name', '"Rubik", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Rubik", sans-serif');
		...
		if($layout == 'fashion5' || $layout == 'fashion7'){
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '1');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
			...
			$results .= $this->updateValue($themeoption . 'p_display', 1);
			$results .= $this->updateValue($themeoption . 'sticky_background', '#FFFFFFCC');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Libre+Franklin:ital,wght@0,100..900;1,100..900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_name', '"Libre Franklin", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Libre+Franklin:ital,wght@0,100..900;1,100..900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Libre Franklin", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_main_color', '#FF6A28');
			$results .= $this->updateValue($themeoption . 'p_name_colorh', '#FF6A28');
			$results .= $this->updateValue($vegamenu . '_behaviour', 2);
			$results .= $this->updateValue('POSSEARCH_CATE', 0);  
            $images = array();
    	}
		...
		if($layout == 'fashion8'){
			...
			$results .= $this->updateValue($themeoption . 'sidebar', 'normal');
			$results .= $this->updateValue($themeoption . 'p_display', 1);
			$results .= $this->updateValue($themeoption . 'sticky_background', '#242428'); 
			$results .= $this->updateValue($themeoption . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Libre+Franklin:ital,wght@0,100..900;1,100..900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_name', '"Libre Franklin", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Libre+Franklin:ital,wght@0,100..900;1,100..900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Libre Franklin", sans-serif');
		...
		if($layout == 'fashion9'  || $layout == 'fashion10' || $layout == 'fashion11' || $layout == 'fashion12'){
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '1');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
		...
		if($layout == 'decoration5' || $layout == 'decoration6'){ 
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '1');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
			...
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Lato", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_main_color', '#E97810');
			$results .= $this->updateValue($themeoption . 'p_name_colorh', '#E97810');
			$results .= $this->updateValue($vegamenu . '_behaviour', 2);
			$results .= $this->updateValue('POSSEARCH_CATE', 0);  
            $images = array();
    	}
		if($layout == 'decoration7'){ 
    		//Theme settings 
			$results .= $this->updateValue($themeoption . 'p_padding', '0');
			$results .= $this->updateValue($themeoption . 'p_border', '1');
			$results .= $this->updateValue($themeoption . 'g_body_bg_image', '');
			...
			$results .= $this->updateValue($themeoption . 'sidebar', 'normal');
			$results .= $this->updateValue($themeoption . 'p_display', 1);
			$results .= $this->updateValue($themeoption . 'sticky_background', '#A1816CCC');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_url', 'https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_body_gfont_name', '"Lato", sans-serif');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_url', 'https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&display=swap');
			$results .= $this->updateValue($themeoption . 'g_title_gfont_name', '"Lato", sans-serif');
    ...
    protected function l($string, $module = 'posthemeoptions', $addslashes = false, $htmlentities = true)
    {
